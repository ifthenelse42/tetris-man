 ...
 *
 * @param actualX1 Coordonnée X1 de la matrice actuelle
 * @param actualX2 Coordonnée X2 de la matrice actuelle
 * @param actualY1 Coordonnée Y1 de la matrice actuelle
 * @param actualY2 Coordonnée Y2 de la matrice actuelle
 * @param allX1 Coordonnée X1 de toutes les autres matrices
 * @param allX2 Coordonnée X2 de toutes les autres matrices
 ...
 * @param max Pointeur vers le nombre maximum de tetrominos en mémoire
 * @param height Pointeur vers la hauteur maximale de la zone de jeu
 *
